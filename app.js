...
var FifteenthTitle = /** @class */ (function () {
    ...
    var _a, _FifteenthTitle_URL, _FifteenthTitle_ID, _FifteenthTitle_get, _FifteenthTitle_detTitleFromJson;
    _a = FifteenthTitle, _FifteenthTitle_get = function _FifteenthTitle_get() {
        fetch(__classPrivateFieldGet(FifteenthTitle, _a, "f", _FifteenthTitle_URL)).then(function (res) {
            ...
            then(function (resData) { return __classPrivateFieldGet(FifteenthTitle, _a, "m", _FifteenthTitle_detTitleFromJson).call(FifteenthTitle, resData); })
            .then(function (title) { return console.log(title); })["catch"](function (_b) {
            var message = _b.message;
            return console.error(message);
        });
    }, _FifteenthTitle_detTitleFromJson = function _FifteenthTitle_detTitleFromJson(resData) {
